...
export const SideBar = () => {
    ...
    const {username, logout, getPropertiesByUser} = useContext(UserContext);
  ...
  return (
      ...
      <div>
        ...
        <p className='text-center text-capitalize'>{username}</p>
      </div>
        <div className="d-flex flex-column lista h-75 justify-content-around align-items-center">
          ...
          <button onClick={()=>getPropertiesByUser()} className="btn links text-center text-decoration-none">Administrar propiedades</button>
